...
\newcommand{\specialcell}[2][c]{%
  \begin{tabular}[#1]{lc}#2\end{tabular}}
...
\title{ Організація та порівняльний аналіз систем контроль версій на різних програмних платформах для організації з розробки конструкторської документації }
% Прізвище, ім'я, по батькові здобувача
\author{Лізанець Данило \\Галушко Олександр}
% Прізвище, ім'я, по батькові наукового керівника/консультанта
\supervisor{Годич О.\,В.}
...
% Тут буде титульна сторінка, колись, можливо
% \maketitle
